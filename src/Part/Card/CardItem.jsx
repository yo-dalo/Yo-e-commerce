...
<div onTouchStart={handleButton} onTouchEnd={closeDeleteButton}  className="w-full flex flex-row centre  h-16">
<button className="full font-medium text-black">DELETE</button>
<div ref={deleteButtonRef} className="h-full w-[0vw]  centre  bg-black">
